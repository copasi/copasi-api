...
foreach (include ${LIBCOPASISE_INCLUDE_DIR})
    string(FIND "${include}" "include" index)

    if (${index} GREATER -1)
        string(REPLACE include share/copasi/CMakeModules LIBCOPASISE_CMAKEMODULE_DIR ${include})
